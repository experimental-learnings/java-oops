	   ...
	   public void playerMove(Seed theSeed) {
	      ...
	      do {
	         if (theSeed == Seed.CROSS) {
			    System.out.print("Player 1 sign 'X', enter your move (row[0-"+(size-1)+"] column[0-"+(size-1)+"]): ");
			 } else  {
			    System.out.print("Player 2 sign 'O', enter your move (row[0-"+(size-1)+"] column[0-"+(size-1)+"]): ");
			 }
	         int row = in.nextInt();
	         int col = in.nextInt();
